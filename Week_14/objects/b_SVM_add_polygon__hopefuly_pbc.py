...
def help():
    ...
    line = LineString([[L/2, 0], [L/2, L]])

    print(line)

    poly_1, poly_2= split(poly, line)

    print(poly_1, poly_2)

    # # plot the polygon
    x_poly_1, y_poly_1 = poly_1.exterior.coords.xy
    plt.plot(x_poly_1, y_poly_1)
    x_poly_2, y_poly_2 = poly_2.exterior.coords.xy
    plt.plot(x_poly_2, y_poly_2)
    plt.show()
