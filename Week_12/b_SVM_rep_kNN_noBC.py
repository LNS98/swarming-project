...
U = 700   # number of updates
noise = 2 # magnitude of varied noise
...
def main():
    ...
    if dimensions == 2:
        # show paths in 2-D
        show_path_2D(0, U, pos_over_t, clear = True)
...
def show_path_2D(start, end, coordinates, clear = True):
    """
    ...
    for time_step in range(start, end):
        ...
        for i in range(N):
            ...
            plt.scatter(coordinates[time_step][i][0], coordinates[time_step][i][1], s = 8, color = 'r')
